...
import co.edu.uptc.views.est202128307.PanelConPage;
...
public class MainFrame extends JFrame {
  ...
  private PanelConPage panelConPage;
  ...
  private void createPanels() {
    ...
    panelCenter.add(panelConPage, PanelEnum.PAGE_CONFIGURATION.toString());
